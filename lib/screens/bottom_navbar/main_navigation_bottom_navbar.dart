...
class MainNavigationBottomNavBar extends StatefulWidget {
  @override
  _MainNavigationBottomNavBarState createState() => _MainNavigationBottomNavBarState();
}

class _MainNavigationBottomNavBarState extends State<MainNavigationBottomNavBar> {
